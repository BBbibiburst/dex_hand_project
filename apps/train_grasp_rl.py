...
def _episode_is_usable(manifest: Path, object_id: str, start_stage: str) -> tuple[bool, bool]:
    ...
    from source.rl.reference import EpisodeRecord, STAGE_CODES
...
def _generate_ultra_reference(
    ...
    from source.rl.reference import resolve_reference_manifest
...
def _train_reference(
    ...
    *,
    ...
    from source.rl.mjwarp_env import MjWarpResidualLiftEnv, ResidualLiftConfig
    from source.rl.ppo import PPOConfig, PPOTrainer
